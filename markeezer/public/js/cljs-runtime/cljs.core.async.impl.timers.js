...
var i_14461 = (0);
while(true){
if((i_14461 < arr.length)){
(arr[i_14461] = null);

var G__14462 = (i_14461 + (1));
i_14461 = G__14462;
continue;
} else {
}
...
var i_14476 = (self__.level + (1));
while(true){
if((i_14476 <= (new_level + (1)))){
(update[i_14476] = self__.header);

var G__14477 = (i_14476 + (1));
i_14476 = G__14477;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14480 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14480[i]));
} else {
x__$2.forward.push((((i < links_14480.length))?(links_14480[i]):null));
}

if((i < links_14480.length)){
(links_14480[i] = x__$2);
} else {
links_14480.push(x__$2);
}
...
var i_14484 = (0);
while(true){
if((i_14484 <= self__.level)){
var links_14485 = (update[i_14484]).forward;
if((x__$1 === (((i_14484 < links_14485.length))?(links_14485[i_14484]):null))){
(links_14485[i_14484] = (x__$1.forward[i_14484]));

var G__14489 = (i_14484 + (1));
i_14484 = G__14489;
continue;
} else {
var G__14490 = (i_14484 + (1));
i_14484 = G__14490;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__14518 = nx;
var G__14519 = (level__$1 - (1));
x = G__14518;
level__$1 = G__14519;
continue;
} else {
var G__14523 = x;
var G__14524 = (level__$1 - (1));
x = G__14523;
level__$1 = G__14524;
continue;
}
